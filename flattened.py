...
class FlattenedDarkStyle(Style):
    """
    The flattened style, dark.
    """
...
class FlattenedLightStyle(FlattenedDarkStyle):
    """
    The flattened style, light.
    """
